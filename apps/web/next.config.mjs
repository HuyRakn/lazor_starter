...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_LAZORKIT_RPC_URL_DEVNET: process.env.NEXT_PUBLIC_LAZORKIT_RPC_URL_DEVNET,
    NEXT_PUBLIC_LAZORKIT_PAYMASTER_URL: process.env.NEXT_PUBLIC_LAZORKIT_PAYMASTER_URL,
    NEXT_PUBLIC_LAZORKIT_PAYMASTER_URL_DEVNET: process.env.NEXT_PUBLIC_LAZORKIT_PAYMASTER_URL_DEVNET,
    NEXT_PUBLIC_LAZORKIT_PORTAL_URL: process.env.NEXT_PUBLIC_LAZORKIT_PORTAL_URL,
    NEXT_PUBLIC_LAZORKIT_PORTAL_URL_DEVNET: process.env.NEXT_PUBLIC_LAZORKIT_PORTAL_URL_DEVNET,
    NEXT_PUBLIC_LAZORKIT_API_KEY: process.env.NEXT_PUBLIC_LAZORKIT_API_KEY,
  },
};
