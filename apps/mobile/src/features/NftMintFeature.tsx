...
import { buildMetaplexInstructions, storeNftMetadata, REGULAR_NFT_SYMBOL } from '../lib/nft-utils';
...
interface NftMintFeatureProps {
    onBack: () => void;
}

export function NftMintFeature({ onBack }: NftMintFeatureProps) {
