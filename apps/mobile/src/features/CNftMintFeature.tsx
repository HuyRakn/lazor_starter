import { View, StyleSheet, TouchableOpacity, ActivityIndicator, Linking, Text } from 'react-native';
import { ArrowLeft, AlertCircle, CheckCircle, ExternalLink, Database } from 'lucide-react-native';
import { useMobileAuth } from '../hooks/useMobileAuth';
import { useMobileGaslessTx } from '../hooks/useMobileGaslessTx';
import { generateMintId, formatTransactionError, validateNftMetadata } from '@lazor-starter/core';
import { buildCNftMintInstruction, storeNftMetadata, extractCNftAssetId, DEMO_MERKLE_TREE, CNFT_SYMBOL } from '../lib/nft-utils';
import { Input, Card, CardContent } from '@lazor-starter/ui';
import { useState } from 'react';
import { CodeExample } from '../components/CodeExample';
import { codeExamples } from '../data/codeExamples';

interface CNftMintFeatureProps {
    onBack: () => void;
}

export function CNftMintFeature({ onBack }: CNftMintFeatureProps) {
