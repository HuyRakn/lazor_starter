...
import { useMobileJupiterSwap } from '../hooks/useMobileJupiterSwap';
import { TOKEN_MINTS, useNetworkStore, useWalletBalance } from '@lazor-starter/core';
...
export function SwapFeature({ onBack }: SwapFeatureProps) {
    const { pubkey } = useMobileAuth();
    const { network } = useNetworkStore();
    const { executeSwap, getQuote, loading: swapLoading, error: swapError, lastSignature } = useMobileJupiterSwap();
